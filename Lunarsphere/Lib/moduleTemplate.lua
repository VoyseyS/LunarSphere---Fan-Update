...
Lunar.Template.template[3] = 
{
	...
	["skin"] = mergeSettings({}, defaultSkinTemplateSettings,
	{
		...
		["gaugeColor"] = mergeSettings({}, Lunar.Sphere.defaultSettings.gaugeColor,
		{
			[LS_EVENT_FIVE] = Lunar.Sphere:GetColorGaugeDefaultSetting(LS_EVENT_FIVE, 0, 0.592156862745098, 1),
			[LS_EVENT_HEALTH] = Lunar.Sphere:GetColorGaugeDefaultSetting(LS_EVENT_FIVE, 0.1372549019607843, 1, 0),
		}),
		["sphereSkin"] = 16,
	}),
	["buttonData"] = {
